...
instructions = {'new_bom_uploading': f"""<h3>Загрузка нового BOM</h3>
                        ...
                        <ul>
                          ...
                          <li>5. Сохранить файл в директорию своего компьютера, указав в его имени только номер пресс-формы. 
                          Чтобы загрузка произошла успешно необходимо убедиться, что пресс-форма под таким номером уже имеется в общем
